...
@test 'version.sh  - File  -  4: Test Patch RC' {
    # get new version
    result=$(echo $(version patch rc) | grep "0.0.1-rc+commit-" | wc -l)
    [ $result -eq 1 ]
    result=$(cat ver)
    [ "$result" == "0.0.0" ]
}
...
@test 'version.sh  - File  -  5: Test Minor RC' {
    # get new version
    result=$(echo $(version minor rc) | grep "0.1.0-rc+commit-" | wc -l)
    [ $result -eq 1 ]
    result=$(cat ver)
    [ "$result" == "0.0.0" ]
}
...
@test 'version.sh  - File  -  6: Test Major RC' {
    # get new version
    result=$(echo $(version major rc) | grep "1.0.0-rc+commit-" | wc -l)
    [ $result -eq 1 ]
    result=$(cat ver)
    [ "$result" == "0.0.0" ]
}
...
@test 'version.sh  - File  -  7: Test Commit' {
    # get new version
    result=$(echo $(version) | grep "0.0.0+commit-" | wc -l)
    [ $result -eq 1 ]
    result=$(cat ver)
    [ "$result" == "0.0.0" ]
}
